package com.example.a3dgraphicsvisualization;
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                switch(seekBar.getId()) {
                    ...
                    case R.id.sb_rotationZ:
                        ...
                        tvRotZ.setText("RTZ: (" + String.format("%03d",sbRotZ.getProgress()) + "°) "); break;
                    ...
                    case R.id.sb_scaleZ:
                        ...
                        tvScaleZ.setText("SLZ: (" + String.format("%1.2f", sbScaleZ.getProgress()/100.0) + ") "); break;

                    case R.id.sb_translationX:
                    case R.id.sb_translationY:
                    case R.id.sb_translationZ:
                        ...
                        tvTrZ.setText("TRZ: (" + String.format("%04d", sbTrZ.getProgress()) + ") "); break;
                    ...
                    case R.id.sb_quatRotationAngle:
                        if (cbQuatX.isChecked()) quatRotationAxes[0] = 1;
                        else quatRotationAxes[0] = 0;

                        if (cbQuatY.isChecked()) quatRotationAxes[1] = 1;
                        else quatRotationAxes[1] = 0;

                        if (cbQuatZ.isChecked()) quatRotationAxes[2] = 1;
                        else quatRotationAxes[2] = 0;
